...
public class HelpState extends State {
    ...
    public void render(SpriteBatch sb) {
        ...
        font.draw(sb, "Your goal is to reach $" + StartParams.MoneyToReach + " in total money made.", 10, height -= 15);
        font.draw(sb, "To grow crops, you must: Plant a seed, press 1.", 10, height -= 25);
        ...
        font.draw(sb, "When they are finished growing, press 4 to harvest.", 10, height -= 15);
